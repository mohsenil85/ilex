...
impl EffectType {
    ...
    pub fn synth_def_name(&self) -> &'static str {
        match self {
            ...
            EffectType::Tremolo => "ilex_tremolo",
            EffectType::Distortion => "ilex_distortion",
            EffectType::Bitcrusher => "ilex_bitcrusher",
            EffectType::Wavefolder => "ilex_wavefolder",
            EffectType::Saturator => "ilex_saturator",
            EffectType::TiltEq => "ilex_tilt_eq",
            EffectType::StereoWidener => "ilex_stereo_widener",
            EffectType::FreqShifter => "ilex_freq_shifter",
            EffectType::Limiter => "ilex_limiter",
            EffectType::PitchShifter => "ilex_pitch_shifter",
            EffectType::Vinyl => "ilex_vinyl",
            EffectType::Cabinet => "ilex_cabinet",
            EffectType::GranularDelay => "ilex_granular_delay",
            EffectType::GranularFreeze => "ilex_granular_freeze",
            EffectType::ConvolutionReverb => "ilex_convolution_reverb",
            EffectType::Vocoder => "ilex_vocoder",
            EffectType::RingMod => "ilex_ringmod",
            EffectType::Autopan => "ilex_autopan",
            EffectType::Resonator => "ilex_resonator",
            EffectType::MultibandComp => "ilex_multiband_comp",
            EffectType::ParaEq => "ilex_para_eq",
            EffectType::SpectralFreeze => "ilex_spectral_freeze",
            EffectType::Glitch => "ilex_glitch",
            EffectType::Leslie => "ilex_leslie",
            EffectType::SpringReverb => "ilex_spring_reverb",
            EffectType::EnvFollower => "ilex_env_follower",
            EffectType::MidSide => "ilex_midside",
            EffectType::Crossfader => "ilex_crossfader",
            EffectType::Denoise => "ilex_denoise",
